var dwQuotes = [
  ...
  "Exterminate!",
  "The universe big. It's vast and complicated and ridiculous. And sometimes, very rarely, impossible things just happen and we call them miracles.",
...
var dwAuthors = [
  ...
  "- The 9th Doctor",
    ...
    function newQuote() {
      var randomNumber = Math.floor(Math.random() * (dwQuotes.length)); 
